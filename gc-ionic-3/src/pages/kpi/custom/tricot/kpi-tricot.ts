...
@IonicPage()
@Component({
    selector: 'page-kpi-tricot',
    templateUrl: 'kpi-tricot.html',
    providers: [GoogleChartComponent]
})

export class KpiTricotPage {
    ...
    private module: string = 'Panel de control'; //Nombre para mostrar del módulo seleccionado
    ...
    async ionViewDidLoad() {
        // track de vista
        this.firebaseAnalyticsProvider.trackView( 'KpiTricot' );
        //this.firebaseAnalyticsProvider.trackScreenEvent( 'KpiTricot', 'KPI' );
    ...
    showAreaDetail(area: any) {
        this.navCtrl.push(AreaDetailTricotPage, { area: area, filters: this.form, charge: this.charge });
    }
}
